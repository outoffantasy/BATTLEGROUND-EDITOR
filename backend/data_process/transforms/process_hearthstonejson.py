...
from data_process.utils.io import load_json, write_json, write_text
from data_process.utils.paths import PROCESSED_ROOT, hearthstonejson_cards_path
...
def image_path(card_id: Any) -> str:
    return f"../raw/hearthstonejson/asset/cards/{card_id}.png"
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--en", default=hearthstonejson_cards_path("enUS"), type=Path, help="Path to enUS cards.json")
    parser.add_argument("--zh", default=hearthstonejson_cards_path("zhCN"), type=Path, help="Path to zhCN cards.json")
    parser.add_argument("--out-dir", default=PROCESSED_ROOT, type=Path, help="Output folder")
